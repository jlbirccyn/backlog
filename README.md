...
With 10 tasks and a backlog equals to 10, 184 756 systems are generated by ```sysgen```. Computation of combinations for theses systems takes about 9 minutes on a MacBook Pro 13" 2017 (2,3 GHz Intel Core i5), half being used for file reading and writing:
